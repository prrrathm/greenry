...
export const NavBar = () => {
	...
	return (
		<div
			className={cn(
				"fixed flex items-center justify-between z-50 px-4 sm:px-8 transition-all duration-500 inset-x-0 top-0",
		...
		>
			...
			>
				<div className="relative top-10 w-16 h-16 sm:w-28 sm:h-28 rounded-full border-[3px] border-white flex items-center justify-center bg-primary shrink-0">
					<Image
						src="/logo/logo-bold.png"
						alt="Evergreenry Logo"
						width={48}
						height={48}
				...
				<span
					className={cn(
						"font-bold text-lg sm:text-xl md:text-2xl uppercase tracking-wide transition-colors duration-300",
						isScrolled ? "text-primary" : "text-white"
					)}
				>
					EVERGREENRY
