...
const services: Service[] = [
	{
		...
		description:
			"With over 1000+ projects spanning 8 million square feet designed and delivered across the globe, our expertise in designing commercial spaces is the best in the industry. We have a design workforce of 100+ architects and interior designers who can handle diverse briefs leveraging our proprietary visualisation technology. Our design visualisation technology provides an immersive experience to our clients facilitating quicker design changes and better space utilisation.",
		imageSrc:
...
const Stacker = () => {
	return (
		<>
			...
			`}</style>
			<div className="bg-[#f5f3ee] text-amber-100 text-center py-[20vh] px-5 md:px-20 md:mt-40">
				...
				>
					<li className="card sticky top-60" id="card-4">
