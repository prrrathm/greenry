...
const blogPosts: BlogPost[] = [
	{
		...
		excerpt:
			"Discover the research-backed benefits of office plants and how they can transform your workspace into a productivity powerhouse.",
	...
	},
	{
		...
		excerpt:
			"From snake plants to pothos, explore the best plant varieties that require minimal care while maximizing air purification benefits.",
	...
	},
	{
		...
		excerpt:
			"Learn the art and science of vertical gardens, from plant selection to irrigation systems and maintenance best practices.",
	...
	},
	{
		...
		excerpt:
			"Explore NASA'apos;s research on air-purifying plants and discover which species are most effective at removing toxins from your space.",
	...
	},
	{
		...
		excerpt:
			"Master the art of seasonal plant maintenance with expert tips for watering, lighting, and care adjustments throughout the year.",
	...
	},
	{
		...
		excerpt:
			"Explore emerging trends in biophilic design and how forward-thinking companies are integrating nature into their office environments.",
		image: "/projects/office-1.jpg",
		author: "Robert Kim",
			...
			<section className="py-16 px-4 sm:px-6 lg:px-8">
				<div className="container mx-auto text-center">
					...
					<p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-8">
						Expert insights, care tips, and the latest trends in office plants
						and biophilic design. Discover how to create healthier, more
						productive environments with our comprehensive guides.
					</p>
			...
			<section className="py-16 bg-primary text-white">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-lg mb-8 opacity-90">
						Get weekly insights on plant care, workplace wellness, and biophilic
						design trends.
					</p>
